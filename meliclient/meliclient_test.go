...
func TestWhenGettingTheCategoryItemsItGetsParsedIntoStruct(t *testing.T) {
	...
	if categoryItemsResponse.Results[0].Price != 1650 {
		t.Fail()
	}

	if categoryItemsResponse.Results[1].Price != 11000 {
		t.Fail()
	}
